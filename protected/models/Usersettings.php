 ...
 * @property integer $id
 * @property integer $filterMale
 * @property integer $filterFemale
...
class Usersettings extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id', 'required'),
			array('id, filterMale, filterFemale, vibrate, sound', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, filterMale, filterFemale, vibrate, sound', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('filterMale',$this->filterMale);
		$criteria->compare('filterFemale',$this->filterFemale);
		$criteria->compare('vibrate',$this->vibrate);
