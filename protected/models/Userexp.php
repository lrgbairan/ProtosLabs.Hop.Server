...
class Userexp extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('expMingle, expAlcohol, expTotal', 'required'),
			array('expMingle, expAlcohol, expTotal', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, expMingle, expAlcohol, expTotal', 'safe', 'on'=>'search'),
		);
	}
